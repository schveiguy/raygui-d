...
enum JUNGLE_STYLE_PROPS_COUNT =  17;

// Custom style name: Jungle
private const(GuiStyleProp)[JUNGLE_STYLE_PROPS_COUNT] jungleStyleProps = [
...
enum JUNGLE_STYLE_FONT_ATLAS_COMP_SIZE = 2030;

// Font atlas image pixels data: DEFLATE compressed
private ubyte[JUNGLE_STYLE_FONT_ATLAS_COMP_SIZE] jungleFontData = [ 0xed,
...
private const(Rectangle)[189] jungleFontRecs = [
    { 4, 4, 5 , 12 },
    { 17, 4, 2 , 7 },
    { 27, 4, 5 , 3 },
    { 40, 4, 5 , 5 },
...
private const(GlyphInfo)[189] jungleFontGlyphs = [
    { 32, 0, 9, 5},
    { 33, 0, 2, 3},
    { 34, 0, 2, 6},
    { 35, 0, 3, 6},
...
void GuiLoadStyleJungle()
{
    ...
    ubyte* data = DecompressData(jungleFontData.ptr, JUNGLE_STYLE_FONT_ATLAS_COMP_SIZE, &jungleFontDataSize);
    ...
    memcpy(font.recs, jungleFontRecs.ptr, font.glyphCount*Rectangle.sizeof);

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = cast(GlyphInfo*)RAYGUI_MALLOC(font.glyphCount*GlyphInfo.sizeof);
    memcpy(font.glyphs, jungleFontGlyphs.ptr, font.glyphCount*GlyphInfo.sizeof);
