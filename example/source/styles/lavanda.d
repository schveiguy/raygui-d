...
enum LAVANDA_STYLE_PROPS_COUNT =  16;

// Custom style name: Lavanda
private const(GuiStyleProp)[LAVANDA_STYLE_PROPS_COUNT] lavandaStyleProps = [
...
enum LAVANDA_STYLE_FONT_ATLAS_COMP_SIZE = 2636;

// Font atlas image pixels data: DEFLATE compressed
private ubyte[LAVANDA_STYLE_FONT_ATLAS_COMP_SIZE] lavandaFontData = [ 0xed,
...
private const(Rectangle)[189] lavandaFontRecs = [
    { 4, 4, 5 , 16 },
    { 17, 4, 1 , 9 },
    { 26, 4, 3 , 3 },
    { 37, 4, 7 , 8 },
...
private const(GlyphInfo)[189] lavandaFontGlyphs = [
    { 32, 0, 12, 5},
    { 33, 0, 3, 2},
    { 34, 0, 3, 4},
    { 35, 0, 3, 8},
...
void GuiLoadStyleLavanda()
{
    ...
    ubyte* data = DecompressData(lavandaFontData.ptr, LAVANDA_STYLE_FONT_ATLAS_COMP_SIZE, &lavandaFontDataSize);
    ...
    font.recs = cast(Rectangle*)RAYGUI_MALLOC(font.glyphCount*Rectangle.sizeof);
    memcpy(font.recs, lavandaFontRecs.ptr, font.glyphCount*Rectangle.sizeof);

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = cast(GlyphInfo*)RAYGUI_MALLOC(font.glyphCount*GlyphInfo.sizeof);
    memcpy(font.glyphs, lavandaFontGlyphs.ptr, font.glyphCount*GlyphInfo.sizeof);
