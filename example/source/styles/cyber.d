...
enum CYBER_STYLE_PROPS_COUNT =  16;

// Custom style name: cyber
private const(GuiStyleProp)[CYBER_STYLE_PROPS_COUNT] cyberStyleProps = [
...
enum CYBER_COMPRESSED_DATA_SIZE = 1104;

// Font image pixels data compressed (DEFLATE)
// NOTE: Original pixel data simplified to GRAYSCALE
private ubyte[CYBER_COMPRESSED_DATA_SIZE] cyberFontData = [ 0xed,
...
private const(Rectangle)[95] cyberFontRecs = [
    { 4, 4, 4 , 14 },
    { 16, 4, 1 , 8 },
    { 25, 4, 4 , 3 },
    { 37, 4, 8 , 8 },
...
private const(GlyphInfo)[95] cyberFontChars = [
    { 32, 0, 11, 4},
    { 33, 0, 3, 2},
    { 34, 0, 3, 4},
    { 35, 0, 3, 8},
...
void GuiLoadStyleCyber()
{
    ...
    ubyte* data = DecompressData(cyberFontData.ptr, CYBER_COMPRESSED_DATA_SIZE, &cyberFontDataSize);
    ...
    memcpy(font.recs, cyberFontRecs.ptr, font.glyphCount*Rectangle.sizeof);

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = cast(GlyphInfo*)malloc(font.glyphCount*GlyphInfo.sizeof);
    memcpy(font.glyphs, cyberFontChars.ptr, font.glyphCount*GlyphInfo.sizeof);
