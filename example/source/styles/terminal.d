...
enum TERMINAL_STYLE_PROPS_COUNT =  16;

// Custom style name: terminal
private const(GuiStyleProp)[TERMINAL_STYLE_PROPS_COUNT] terminalStyleProps = [
...
enum TERMINAL_COMPRESSED_DATA_SIZE = 964;

// Font image pixels data compressed (DEFLATE)
// NOTE: Original pixel data simplified to GRAYSCALE
private ubyte[TERMINAL_COMPRESSED_DATA_SIZE] terminalFontData = [ 0xed,
...
private const(Rectangle)[95] terminalFontRecs = [
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 11 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 11 },
...
private const(GlyphInfo)[95] terminalFontChars = [
    { 32, 0, 14, 4},
    { 33, 1, 3, 3},
    { 34, 1, 3, 5},
    { 35, 1, 3, 8},
...
void GuiLoadStyleTerminal()
{
    ...
    ubyte* data = DecompressData(terminalFontData.ptr, TERMINAL_COMPRESSED_DATA_SIZE, &terminalFontDataSize);
    ...
    memcpy(font.recs, terminalFontRecs.ptr, font.glyphCount*Rectangle.sizeof);

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = cast(GlyphInfo*)malloc(font.glyphCount*GlyphInfo.sizeof);
    memcpy(font.glyphs, terminalFontChars.ptr, font.glyphCount*GlyphInfo.sizeof);
