...
enum BLUISH_STYLE_PROPS_COUNT =  14;

// Custom style name: bluish
private const(GuiStyleProp)[BLUISH_STYLE_PROPS_COUNT] bluishStyleProps = [
...
enum BLUISH_COMPRESSED_DATA_SIZE = 1423;

// Font image pixels data compressed (DEFLATE)
// NOTE: Original pixel data simplified to GRAYSCALE
private ubyte[BLUISH_COMPRESSED_DATA_SIZE] bluishFontData = [ 0xed,
...
private const(Rectangle)[95] bluishFontRecs = [
    { 4, 4, 5 , 10 },
    { 17, 4, 2 , 8 },
    { 27, 4, 4 , 3 },
    { 39, 4, 6 , 8 },
...
private const(GlyphInfo)[95] bluishFontChars = [
    { 32, 0, 9, 5},
    { 33, 0, 1, 2},
    { 34, 0, 1, 4},
    { 35, 0, 1, 6},
...
void GuiLoadStyleBluish()
{
    ...
    ubyte* data = DecompressData(bluishFontData.ptr, BLUISH_COMPRESSED_DATA_SIZE, &bluishFontDataSize);
    ...
    memcpy(font.recs, bluishFontRecs.ptr, font.glyphCount*Rectangle.sizeof);

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = cast(GlyphInfo*)malloc(font.glyphCount*GlyphInfo.sizeof);
    memcpy(font.glyphs, bluishFontChars.ptr, font.glyphCount*GlyphInfo.sizeof);
