...
enum DARK_STYLE_PROPS_COUNT =  22;

// Custom style name: dark
private const(GuiStyleProp)[DARK_STYLE_PROPS_COUNT] darkStyleProps = [
...
enum DARK_COMPRESSED_DATA_SIZE = 1031;

// Font image pixels data compressed (DEFLATE)
// NOTE: Original pixel data simplified to GRAYSCALE
private ubyte[DARK_COMPRESSED_DATA_SIZE] darkFontData = [ 0xed,
...
private const(Rectangle)[95] darkFontRecs = [
    { 4, 4, 4 , 16 },
    { 16, 4, 1 , 9 },
    { 25, 4, 3 , 3 },
    { 36, 4, 6 , 9 },
...
private const(GlyphInfo)[95] darkFontChars = [
    { 32, 0, 13, 4},
    { 33, 2, 4, 5},
    { 34, 2, 4, 7},
    { 35, 1, 4, 8},
...
void GuiLoadStyleDark()
{
    ...
    ubyte* data = DecompressData(darkFontData.ptr, DARK_COMPRESSED_DATA_SIZE, &darkFontDataSize);
    ...
    memcpy(font.recs, darkFontRecs.ptr, font.glyphCount*Rectangle.sizeof);

    // Copy font char info data from global fontChars
    // NOTE: Required to avoid issues if trying to free font
    font.glyphs = cast(GlyphInfo*)malloc(font.glyphCount*GlyphInfo.sizeof);
    memcpy(font.glyphs, darkFontChars.ptr, font.glyphCount*GlyphInfo.sizeof);
